            ...
            <div class={style.sectionF + " grid lg:grid-cols-3 md:grid-cols-2 p-4  flex justify-center align-center mx-auto"}>
                <div class="col-lg-4 col-md-6 col-sm-12 w-100 padd_15">
                    <div class={style.div_card}>
                        <div class="mb-[35px]">
                            <Image src="/cityscape (1).png" width={100} height={130} alt="" class={style.icon_61}/>
                        </div>
                ...
                <div class=" w-100 col-lg-4 col-md-6 col-sm-12 padd_15">
                    <div class={style.div_card}>
                        <div class="mb-[35px]">
                            <Image src="/skyline (1).png" width={100} height={130} alt="" class={style.icon_61}/>
                        </div>
                ...
                <div class="w-100 col-lg-4 col-md-6 col-sm-12 padd_15">
                    <div class={style.div_card}>
                        <div class="mb-[35px]">
                            <Image src="/sketch (1).png" width={100} height={130} class={style.icon_61} alt=""/>
                        </div>
