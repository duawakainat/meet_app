...
const Section1 = (props) => {
    return (
        <div className={style.marg_B}>
            <div className={style.sectionF + ' self-start'}>
                <div className={style.marG_T + ' card self-start section_F marG_T position-relative z-3'}>
                    <div
                        className={style.Display_col + ' flex lg:flex-row md:flex-col sm:flex-col mx-auto lg:!justify-center flex-xl-row flex-lg-column flex-md-column flex-sm-column flex-xs-column self-start Display_col bottom_marP'}>
                        <div
                            ...
                            <Image src="/personal.jpg.webp" width={700} height={500} className={style.img_size} fluid alt="..." />
                        </div>
